export const translations = {
  en: {
    ...
    projects: [
      ...
      },
      {
        ...
        context: "Published Essay · PhilArchive · 2025",
        description: "A short essay on the epistemic status of modeling, connecting Ashby's cybernetics to Bruno Latour's ontological pluralism.",
      ...
      },
      {
        ...
        context: "Essay · 2025",
        description: "An essay connecting political philosophy, participatory governance and digital technology.",
      ...
      },
      {
        ...
        context: "Institut Jean Nicod · ENS - PSL · 2025",
  ...
  fr: {
    ...
    projects: [
      ...
      {
        title: "Misplaced Concreteness, Expected Completeness",
        context: "Essai publié · PhilArchive · 2025",
        description: "Un court essai sur le statut épistémique de la modélisation, reliant la cybernétique d'Ashby au pluralisme ontologique de Bruno Latour.",
        image: "ashby-latour.jpg",
        alt: "Ashby et Latour",
        link: "https://philarchive.org/rec/PRAMCE-4",
        type: "research",
      },
      {
        title: "Un philosophe roi numérique",
        context: "Essai · 2025",
        description: "Un essai reliant philosophie politique, gouvernance participative et technologie numérique.",
        image: "philosophe-roi.jpg",
